...
###################
#deploys aws-network-firewall module
module "aws_network_firewall" {
  ...
  #technically optional due to dynamic
...
#flag used to modify RTB to point NFW RTB to the IGW when NFW in use
...
#flag used to modify RTB to point inbound public originating traffic from the public subnet to the AWS NFW
...
#flag used go create the RTB needed for the igw nfw deployment that gets attached to the IGW
...
#flag for route entries to be ceated for the IGW RTB
...
#the RTB association to the IGW
...
#firewall subnet creation - completely optional in this module.
################
# Firewall subnet
################
