...
//  value       = "${element(concat(aws_vpc.this.*.enable_classiclink, tolist([""])), 0)}"
//}
...
//  value       = "${element(concat(aws_vpc.this.*.ipv6_association_id, tolist([""])), 0)}"
//}
//
//output "vpc_ipv6_cidr_block" {
//  description = "The IPv6 CIDR block"
//  value       = "${element(concat(aws_vpc.this.*.ipv6_cidr_block, tolist([""])), 0)}"
//}
...
output "siem_subnets" {
  description = "List of IDs of siem subnets"
...
//  description = "Whether or not the VPC has Classiclink enabled"
//  value       = "${element(concat(aws_default_vpc.this.*.enable_classiclink, tolist([""])), 0)}"
//}
...
//  description = "The association ID for the IPv6 CIDR block"
//  value       = "${element(concat(aws_default_vpc.this.*.ipv6_association_id, tolist([""])), 0)}"
//}
//
//output "default_vpc_ipv6_cidr_block" {
//  description = "The IPv6 CIDR block"
//  value       = "${element(concat(aws_default_vpc.this.*.ipv6_cidr_block, tolist([""])), 0)}"
//}
